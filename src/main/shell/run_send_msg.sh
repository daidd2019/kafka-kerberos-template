...
java  ${KAFKA_CLIENT_KERBEROS_PARAMS} $LOG4J_PARAMS -cp $jars  kafka.ProducerMsg  -t topic1 -b ck1.centos74.com:6667,ck2.centos74.com:6667,ck3.centos74.com:6667,ck4.centos74.com:6667 -s SASL_PLAINTEXT -n 10000
